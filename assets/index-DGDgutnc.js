...
`].filter(cl).join(`
`)),u=up(u),u=O_(u,n),u=I_(u,n),h=up(h),h=O_(h,n),h=I_(h,n),u=P_(u),h=P_(h),n.isRawShaderMaterial!==!0&&(N=`#version 300 es
...
`)+`
`+v);const D=N+b+u,O=N+v+h,H=U_(r,r.VERTEX_SHADER,D),L=U_(r,r.FRAGMENT_SHADER,O);r.attachShader(E,H),r.attachShader(E,L),n.index0AttributeName!==void 0?r.bindAttribLocation(E,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(E,0,"position"),r.linkProgram(E);function P(k){if(o.debug.checkShaderErrors){const ne=r.getProgramInfoLog(E)||"",le=r.getShaderInfoLog(H)||"",me=r.getShaderInfoLog(L)||"",fe=ne.trim(),z=le.trim(),j=me.trim();let Y=!0,xe=!0;if(r.getProgramParameter(E,r.LINK_STATUS)===!1)if(Y=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(r,E,H,L);else{const _e=N_(r,H,"vertex"),I=N_(r,L,"fragment");vt("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(E,r.VALIDATE_STATUS)+`
